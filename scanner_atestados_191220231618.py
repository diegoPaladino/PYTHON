...
'''
1. ESCANEAR TODAS AS FOLHAS, JUNTO AO ATESTADO, POR ORDEM ALFABÉTICA

2. POSICIONAR DUAS PASTAS ABERTAS SENDO:
    1. LADO ESQUERDO: PASTA COMPARTILHADA ONDE IRÃO PARAR AS FOLHAS DE PONTOS E ATESTADOS ESCANEADOS
    2. LADO DIREITO: PASTA CRIADA COM X NÚMERO DE PASTAS NOVAS
...
def folha_atestado():
    ...
    p.click()
    t.sleep(0.1)
    # clicando na PASTA de SCANNER, ABERTA PRIMEIRO E POSICIONADA À ESQUERDA
    ...
    p.click()
    t.sleep(0.1)
    # clicando na PASTA de LISTA de funcionários, do MES referente aos lançamentos, , ABERTA APÓS A DE SCANNER E POSICIONADA À DIREITA
...
def folha():
    ...
    # selecionar nome de funcionário
